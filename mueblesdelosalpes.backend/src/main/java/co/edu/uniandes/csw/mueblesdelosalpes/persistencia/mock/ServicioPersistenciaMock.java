...
public class ServicioPersistenciaMock implements IServicioPersistenciaMockRemote, IServicioPersistenciaMockLocal {
    ...
    public ServicioPersistenciaMock() {
        if (vendedores == null) {
            ...
            ofertas.add(new Oferta(0, TipoUsuario.Cliente, muebles.get(0).getReferencia(), 100000));
            ofertas.add(new Oferta(0, TipoUsuario.Cliente, muebles.get(1).getReferencia(), 110000));
        }
    }
    ...
    public Object findById(Class c, Object id) {
        if (c.equals(Vendedor.class)) {
            ...
            for (Object v : findAll(c)) {
                ...
                if (oferta.getIdOferta() == Long.parseLong(id.toString())) {
                    return oferta;
                }
            }
        }
